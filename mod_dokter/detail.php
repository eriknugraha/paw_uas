...
<?php
$kodeuser=$_GET['kodedk'];
$query=mysql_query("SELECT * FROM tdokter WHERE id_dokter='$kodeuser'");
            ...
            <div class="span12 pull-left">
                ...
                <div class="clearfix">
                                 ...
                                 <i class="ace-icon fa fa-umbrella bigger-120 blue"></i>
                                      Silahkan detail dokter <b><?php echo $r['nama'];?></b>
                                         </div>
                <div class="clear"></div>
                ...
                <div class="span8">                         
                    ...
                    <thead>
                        <tr >
                            <td width="100px" align="right" bgcolor="#DEB887  "><label class="control-label" for="inputPassword">&nbsp;ID Dokter </label></td>
                            <td>&nbsp;&nbsp;<?php echo $r['id_dokter'] ?></td>
                        </tr>
                        <tr >
                            <td width="100px" align="right" bgcolor="#DEB887  "><label class="control-label" for="inputPassword">&nbsp;Nip </label></td>
