...
<!-- / ################################# KOLOM SAMPING UNTUK ID kLIEN DOKTER ###########################################-->	
			...
			<div class="span10 thumb pull-right">
				...
				$kode=$_GET['id'];
				$id=$_GET['kodem'];
				$querm=mysql_query("SELECT * FROM tmedis where kode='$kode' and id_member='$id'");
				$ru=mysql_fetch_array($querm);
...
<div class="span3 offset1">
								...
								<div class="control-group">
									...
									<div class="controls">
									<input type="text" class="span8" value="<?php echo $kode ?>" disabled>
									<input type="hidden" class="span8" value="<?php echo $kode ?>" name="t1">
									<input type="hidden" class="span8" value="<?php echo $id ?>" name="t2">
								...
								if($fsk=='Y'){
								?>
									<input type="checkbox" name="fsk" value="Y" checked>
									Pemeriksaan Fisik
								<?php
								}
								else {
								...
								if($ppe=='Y'){
								?>
									<input type="checkbox" name="ppe" value="Y" checked>
									Pemeriksaan PPE
								<?php
								}
								else {
								...
								if($rice=='Y'){
								?>
									<input type="checkbox" name="rice" value="Y" checked>
									Penanganan RICE
								<?php
								}
								else {
								...
								<div class="control-group">
									<div class="controls">                                          
                                <?php
								$konsul_gizi=$ru['konsul_gizi'];
								if($konsul_gizi=='Y'){
								?>
									<input type="checkbox" name="konsul_gizi" value="Y" checked>
									Konsultasi Gizi
								<?php
								}
								else {
								...
								<div class="control-group">
									<div class="controls">                                          
                                <?php
								$konsul_umum=$ru['konsul_umum'];
								if($konsul_umum=='Y'){
								?>
									<input type="checkbox" name="konsul_umum" value="Y" checked>
									Konsultasi Umum
								<?php
								}
								else {
								...
								if($ekg=='Y'){
								?>
									<input type="checkbox" name="ekg" value="Y" checked>
									Pemeriksaan EKG
								<?php
								}
								else {
								...
								<?php } ?>
                                          ...
                                          <br>
											 ...
											 <select name="krt_ekg">  
											 <option value="<?php echo $ru['krt_ekg']; ?>"><?php echo $ru['krt_ekg']; ?></option>  
			...
			<input type="text" id="inputText" name="bb" class="span4" value="<?php echo $ru['bb']; ?>">&nbsp;kg
								   	 </div>
								...
								<div class="control-group">
									...
									<label class="control-label" for="inputPassword">Tinggi Badan</label>
									  		...
									  		<input type="text" id="inputText" name="tb" class="span4" value="<?php echo $ru['tb']; ?>">&nbsp;cm
								   	 </div>
...
<div class="span3 offset1">
								...
								<div class="control-group">
									...
									<label class="control-label" for="inputPassword">Indeks Masa Tubuh</label>
									  		...
									  		<input type="text" id="inputText" name="imt" class="span4" value="<?php echo $ru['imt']; ?>">
									  	 
											 <select name="krt_imt">  
											 <option value="<?php echo $ru['krt_imt']; ?>"><?php echo $ru['krt_imt']; ?></option> 
								...
								<div class="control-group">
									...
									<label class="control-label" for="inputPassword">Lingkar Tubuh</label>
									  		...
									  		<input type="text" id="inputText" name="lingktbh" class="span4" value="<?php echo $ru['lingktbh']; ?>">&nbsp;cm
									  		
											 <select name="krt_lingktbh">  
											 <option value="<?php echo $ru['krt_lingktbh']; ?>"><?php echo $ru['krt_lingktbh']; ?></option>  
											 <option value="normal">Normal</option>  
								...
								<div class="control-group">
									  		...
									  		<input type="text" id="inputText" name="nadi" class="span4" value="<?php echo $ru['nadi']; ?>">
									  	 
											 <select name="krt_nadi">  
											 <option value="<?php echo $ru['krt_nadi']; ?>"><?php echo $ru['krt_nadi']; ?></option> 
								...
								<div class="control-group">
									<label class="control-label" for="inputPassword">Tekanan Darah</label>
									  		...
									  		<input type="text" id="inputText" name="tek_drh" class="span4" value="<?php echo $ru['tek_drh']; ?>">
									  		
											 <select name="krt_tekdrh">  
											 <option value="<?php echo $ru['krt_tekdrh']; ?>"><?php echo $ru['krt_tekdrh']; ?></option> 
...
<div class="control-group">
									<label class="control-label" for="inputPassword">Nadi Istirahat</label>
									  		...
									  		<input type="text" id="inputText" name="nadi_istirahat" class="span4" value="<?php echo $ru['nadi_istirahat']; ?>">
									  		
											 <select name="k_nadi_istirahat"> 
											 <option value="<?php echo $ru['k_nadi_istirahat']; ?>"><?php echo $ru['k_nadi_istirahat']; ?></option>  
											 <option value="Baik Sekali">Baik Sekali</option>  
											 <option value="Baik">Baik</option>  
											 <option value="Normal">Cukup</option>  
											 <option value="Kurang">Kurang</option>  
...
<div class="span3 offset1">
                    ...
                    <div class="control-group">
						...
						<div class="controls">
						  <input type="text" id="inputText" name="skinfold" class="span4" value="<?php echo $ru['skinfold']; ?>">
					   </div>
				    </div>
                    ...
                    <div class="control-group">
						...
						<div class="controls">
						   <input type="text" id="inputText" name="fat" class="span4" value="<?php echo $ru['fat']; ?>">
					   </div>
				    </div>
                    ...
                    <div class="control-group">
						...
						<div class="controls">
						   <input type="text" id="inputText" name="ot_kanan" class="span4" value="<?php echo $ru['ot_kanan']; ?>">
					   </div>
				    </div>
                    ...
                    <div class="control-group">
						...
						<div class="controls">
						   <input type="text" id="inputText" name="ot_kiri" class="span4" value="<?php echo $ru['ot_kiri']; ?>">
					   </div>
				    </div>
                    <div class="control-group">
						...
						<div class="controls">
						   ...
						   <input type="text" id="inputText" name="ot_leg" class="span4" value="<?php echo $ru['ot_leg']; ?>">
					   </div>
				    </div>
                    <div class="control-group">
						<label class="control-label" for="inputPassword">Kekuatan Otot Back</label>
						<div class="controls">
						   <input type="text" id="inputText" name="ot_back" class="span4" value="<?php echo $ru['ot_back']; ?>">
					   </div>
				    </div>
				     ...
				     <div class="control-group">
						...
						<div class="controls">
						   <input type="text" id="inputText" name="flex" class="span4" value="<?php echo $ru['flex']; ?>">
					   </div>
				    </div>
                    ...
                    <div class="control-group">
						...
						<div class="controls">
						   <input type="text" id="inputText" name="daya_ldk" class="span4" value="<?php echo $ru['daya_ldk']; ?>">
					   </div>
				    </div>
</div>
<div class="span3" offset>                    
				    ...
				    <label> &nbsp;</label>
											 ...
											 <option value="<?php echo $ru['krt_skinfold']; ?>"><?php echo $ru['krt_skinfold']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
											 <option value="Normal">Normal</option>
				    ...
				    <br>
											 ...
											 <select name="krt_fat">  
											 <option value="<?php echo $ru['krt_fat']; ?>"><?php echo $ru['krt_fat']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
											 <option value="Normal">Normal</option>
											 <option value="Lebih">Lebih</option>
				   ...
				   <br>
				    ...
				    <br>
											 ...
											 <option value="<?php echo $ru['krt_ka_ki']; ?>"><?php echo $ru['krt_ka_ki']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
				    ...
				    <label> &nbsp;</label>
											 ...
											 <option value="<?php echo $ru['krt_ot_leg']; ?>"><?php echo $ru['krt_ot_leg']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
											 <option value="Cukup">Cukup</option>
											 <option value="Kurang">Kurang</option>
				    ...
				    <br>
											 ...
											 <option value="<?php echo $ru['krt_ot_back']; ?>"><?php echo $ru['krt_ot_back']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
											 <option value="Cukup">Cukup</option>
											 <option value="Kurang">Kurang</option>
				    ...
				    <br>
											 ...
											 <option value="<?php echo $ru['krt_flex']; ?>"><?php echo $ru['krt_flex']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
											 <option value="Cukup">Cukup</option>
											 <option value="Kurang">Kurang</option>
				    ...
				    <br>
											 ...
											 <option value="<?php echo $ru['krt_daya_ldk']; ?>"><?php echo $ru['krt_daya_ldk']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
											 <option value="Cukup">Cukup</option>
											 <option value="Kurang">Kurang</option>
...
<!-- /#############################################TAMBAH TABEL JANTUNG PARU DAN KEPADATAN TULANG############################### -->	
 ...
 <div class="span3 offset1">
                    ...
                    <div class="control-group">
						...
						<div class="controls">
						  <input type="text" id="inputText" name="bangku" class="span4" value="<?php echo $ru['bangku']; ?>">
					   </div>
				    </div>
                    ...
                    <div class="control-group">
						...
						<div class="controls">
						  <input type="text" id="inputText" name="sepeda" class="span4" value="<?php echo $ru['sepeda']; ?>">
					   </div>
				    </div>
                    ...
                    <div class="control-group">
						...
						<div class="controls">
						  <input type="text" id="inputText" name="treadmill" class="span4" value="<?php echo $ru['treadmill']; ?>">
					   </div>
				    </div>
                    ...
                    <br>
						...
						<div class="controls">
						  <input type="text" id="inputText" name="rockport" class="span4" value="<?php echo $ru['rockport']; ?>">
					   </div>
				    </div>
                    ...
                    <div class="control-group">
						...
						<div class="controls">
						  ...
						  <input type="text" id="inputText" name="spiro" class="span4" value="<?php echo $ru['spiro']; ?>">
					   </div>
				    </div>
                    <div class="control-group">
						<label class="control-label" for="inputPassword">Tes Densitometri</label>
						<div class="controls">
						  <input type="text" id="inputText" name="densito" class="span4" value="<?php echo $ru['densito']; ?>">
					   </div>
				    </div>
...
<div class="span3" offset>                    
				    ...
				    <label> &nbsp;</label>
											 ...
											 <option value="<?php echo $ru['krt_bangku']; ?>"><?php echo $ru['krt_bangku']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
											 <option value="Normal">Normal</option>
											 <option value="Lebih">Lebih</option>
				    ...
				    <br>
											 ...
											 <option value="<?php echo $ru['krt_sepeda']; ?>"><?php echo $ru['krt_sepeda']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
											 <option value="Normal">Normal</option>
											 <option value="Lebih">Lebih</option>
				    ...
				    <br>
											 ...
											 <option value="<?php echo $ru['krt_treadmill']; ?>"><?php echo $ru['krt_treadmill']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
											 <option value="Cukup">Cukup</option>
											 <option value="Kurang">Kurang</option>
				    ...
				    <br>
											 ...
											 <option value="<?php echo $ru['krt_rockport']; ?>"><?php echo $ru['krt_rockport']; ?></option>  
											 <option value="baik sekali">Baik Sekali</option>  
											 <option value="baik">Baik</option>
											 <option value="Cukup">Cukup</option>
											 <option value="Kurang">Kurang</option>
				    ...
				    <br>
											 ...
											 <option value="<?php echo $ru['krt_spiro']; ?>"><?php echo $ru['krt_spiro']; ?></option>  
				    ...
				    <br>
											 ...
											 <option value="<?php echo $ru['krt_densito']; ?>"><?php echo $ru['krt_densito']; ?></option>  
											 <option value="baik sekali">Normal</option>  
...
<br><br><br>
								...
								<div class="controls">
	                 <input type="text" class="span10" id="inputText" name="pemeriksa" value="<?php echo $_ru['pemeriksa']; ?>" readonly> 
	                 </div></div>
	                             <?php }?>
	                         <?php if ($_SESSION['akses']!="2") {?>
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control" name="pemeriksa">
                                           ...
                                           <?php
												...
												echo "<option>$ru[pemeriksa]</option>";
					...
					<div class="control-group">
								...
								<div class="controls">
								<textarea type="text" name="kesimpulan" class="span12" id="inputText"style="margin-top: 0px; margin-bottom: 10px; height: 168px;"><?php echo $ru['kesimpulan']; ?> </textarea>
