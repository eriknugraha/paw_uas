...
var $ez=array('fontSize'=>30); // used for storing most of the page configuration parameters
...
function Cezpdf($paper='b1',$orientation='portrait'){
...
function ezTable(&$data,$cols='',$title='',$options=''){
  ...
  $defaults = array(
    'shaded'=>1,'showLines'=>1,'shadeCol'=>array(0.8,0.8,0.8),'shadeCol2'=>array(0.7,0.7,0.7),'fontSize'=>13,'titleFontSize'=>30
