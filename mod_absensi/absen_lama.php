...
$nounik=$acak1."-".$acak2;
    ...
    $z='';
     ...
     if($_POST){
            $id_member = $_POST['idd'];
            $sql= "select a.id_member,a.nama_member,a.tgl_lahir,a.sex,a.tgl_daftar,a.photo,a.status, b.tgl_bayar from tmember a INNER JOIN tbyr b on a.id_member = b.id_member where a.id_member ='$id_member' and b.jns_bayar='perpanjang' ORDER BY b.tgl_bayar DESC LIMIT 1 ";
