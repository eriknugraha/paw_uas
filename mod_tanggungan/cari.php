...
$kodepasien=$_POST['q'];
$aksi="mod_pasien/tanggungan.php";
?>
...
<table class="table table-striped">
					...
					<tbody>
					<?php					
					$query=mysql_query("SELECT * FROM tmember where id_member LIKE '%".$kodepasien."%' And status='non-member' or nama_member  LIKE '%".$kodepasien."%' And status='non-member'");
					$no=1;
